...
- [x] `INSTALL_FLOW.md` must synthesize the shared installer claim across all three snapshots.
- [x] `MISSIONS_FINDINGS.md` must cite each snapshot path directly.
- [x] `evidence/INDEX.md` must map each raw evidence file back to its snapshot.
